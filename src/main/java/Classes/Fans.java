...
//    private int IdCh=0;
    ...
    public void createCharacter(String name,int hability, int strength, int hp, int agility, String Object, int id){
        Character personaje = new Character(name,hability, strength, hp, agility, Object,id);
